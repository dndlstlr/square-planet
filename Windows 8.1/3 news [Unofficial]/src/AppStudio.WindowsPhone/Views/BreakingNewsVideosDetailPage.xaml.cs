...
{
    public sealed partial class BreakingNewsVideosDetail : Page
    {
        private NavigationHelper _navigationHelper;

        private DataTransferManager _dataTransferManager;

        public BreakingNewsVideosDetail()
        {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            BreakingNewsVideosModel.SelectItem(e.Parameter);

            if (BreakingNewsVideosModel != null)
            {
                BreakingNewsVideosModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
        }
