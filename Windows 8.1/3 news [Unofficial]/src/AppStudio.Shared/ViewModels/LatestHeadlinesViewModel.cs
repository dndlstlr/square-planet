...
{
    public class LatestHeadlinesViewModel : ViewModelBase<RssSchema>
    {
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("LatestHeadlinesDetail", item);
                        });
                }
        ...
        {
            return new LatestHeadlinesDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("LatestHeadlinesList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("LatestHeadlinesDetail");
        }
    }
}
