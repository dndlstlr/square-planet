...
{
    public class ScienceAndTechnologyViewModel : ViewModelBase<RssSchema>
    {
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("ScienceAndTechnologyDetail", item);
                        });
                }
        ...
        {
            return new ScienceAndTechnologyDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ScienceAndTechnologyList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ScienceAndTechnologyDetail");
        }
    }
}
