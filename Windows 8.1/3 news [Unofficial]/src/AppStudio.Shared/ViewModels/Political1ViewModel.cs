...
{
    public class Political1ViewModel : ViewModelBase<RssSchema>
    {
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("Political1Detail", item);
                        });
                }
        ...
        {
            return new Political1DataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("Political1List");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("Political1Detail");
        }
    }
}
