...
{
    public class WorldViewModel : ViewModelBase<RssSchema>
    {
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("WorldDetail", item);
                        });
                }
        ...
        {
            return new WorldDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("WorldList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("WorldDetail");
        }
    }
}
