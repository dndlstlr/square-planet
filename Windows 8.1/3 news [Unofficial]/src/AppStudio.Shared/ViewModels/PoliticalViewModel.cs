...
{
    public class PoliticalViewModel : ViewModelBase<RssSchema>
    {
                ...
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            ...
                            NavigationServices.NavigateToPage("PoliticalDetail", item);
                        });
                }
        ...
        {
            return new PoliticalDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("PoliticalList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("PoliticalDetail");
        }
    }
}
